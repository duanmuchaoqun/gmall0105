...
public class TestCnsumer3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //将话题消费者持久化
            MessageConsumer consumer = session.createDurableSubscriber(topic,"test3");
                ...
                public void onMessage(Message message) {
                    if(message instanceof TextMessage){
                        try {
                            ...
                            System.out.println(text+"我来了，我来执行...我是test3");
